...
fun WelcomeScreen(onCreateAccount: () -> Unit, onLogin: () -> Unit) {
    Column(modifier = Modifier.fillMaxSize().padding(horizontal = 28.dp)) {
        Column(
            ...
            Box(
                modifier = Modifier.size(84.dp).background(Primary, RoundedCornerShape(24.dp)),
                contentAlignment = Alignment.Center
            ) {
                Icon(Icons.Filled.ShowChart, contentDescription = null, tint = Color.White, modifier = Modifier.size(34.dp))
            }
